...
node1 = SshNode(gateway = faraday, hostname = "fit36", username = "container",
                verbose = verbose_ssh)
...
ping = SshJob(
    node = faraday,
    command = Run('baleine', 'deploy', '--nodes', '36', '--image', 'ghcr.io/haysberg/baleine:main', '--command', 'ping', '-c1', 'google.fr'),
    scheduler = scheduler)
